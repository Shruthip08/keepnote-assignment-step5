...
public class ReminderServiceImpl implements ReminderService {
	...
	public Reminder createReminder(Reminder reminder) throws ReminderNotCreatedException {
		...
		Optional<Reminder> currentReminder = this.reminderRepository.findById(reminder.getReminderId());
	...
	public boolean deleteReminder(String reminderId) throws ReminderNotFoundException {
		...
		Optional<Reminder> optional = this.reminderRepository.findById(reminderId);
		if(optional.isPresent()) {
			
			this.reminderRepository.delete(optional.get());
			status = true;
		}
		else {
	...
	public Reminder updateReminder(Reminder reminder,String reminderId) throws ReminderNotFoundException {
		...
		if(optional.isPresent()) {
		 this.reminderRepository.save(optional.get());
		 return reminder;
		}
		else {
			throw new ReminderNotFoundException("reminder Not Found");
